...
class Zend_Locale_Format
{
     ...
     * according to the vehicle described in $format.  For a format of 'H:m:s', and
     ...
     * extracted from $datetime according to the vehicle described in $format.  For a format of 'd.M.y H:m:s',
